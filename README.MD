...
### Usage
This project uses gradle to manage dependencies. The only external dependencies are JUnit5 framework related.  
...
Design decisions and assumptions made include:
  * I decided to use Java, gradle and JUnit5 to build and test my project. 
